package bp.goalsgames.blockbalance.prefs
...
data class GateResult(
    ...
    companion object {
        fun native(answered: Boolean = true) = GateResult(false, null, 0L, answered)
        fun unreachable() = native(answered = false)
        fun stream(url: String, exp: Long = 0L) = GateResult(true, url, exp, true)
    }
}
